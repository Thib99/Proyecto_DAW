    ...
    <div class="m-2">
        ...
        <table class="table table-dark table-striped table-bordered">
            ...
            <tbody class="align-middle text-center">
                ...
                <tr >
                    <td>
                            <form action="/" method="POST" id="form-add-product" ></form>
                            <div class="image-container" onclick="selectImage(this)">
                                <input type="file" class="input-invisible" required form="form-add-product" >
                        ...
                        <td>
                            <div class="image-container" onclick="selectImage(this)">
                                <input type="file" class="input-invisible" form="form-add-product" >
                                <img class="uploaded-image" src="img/placeholder-img.jpg" alt="Uploaded Image">
                            </div>
                        ...
                        <td><input type="number" class="form-control-plaintext text-white"  name="precio" required form="form-add-product"   
                ...
                <tr>
                    <td>
                        <form action="/" method="POST" id="<?php echo $id_form ?>"></form>

                            <input type="hidden" name="codigo" form="<?php echo $id_form ?>" value="<?php echo $fila[0] ?>">
                            <div class="image-container" onclick="selectImage(this)">
                                <input type="file" class="input-invisible" disabled form="<?php echo $id_form ?>">
                        ...
                        <td><input type="text" class="form-control-plaintext text-white" form="<?php echo $id_form ?>"  name="nombre"
                                disabled value="<?php echo $fila[4] ?>"></td>

                        <td><input type="number" class="form-control-plaintext text-white" form="<?php echo $id_form ?>"   
                                name="cantidad" disabled value="<?php echo $fila[5] ?>"></td>

                        <td><input type="number" class="form-control-plaintext text-white" form="<?php echo $id_form ?>"   name="precio"
                                disabled value="<?php echo $fila[6] ?>"></td>
                        <td>
                            <select class="form-control-plaintext text-white" form="<?php echo $id_form ?>"  name="categoria" disabled>
                                <?php
                                    foreach ($categorias as $key => $value){
                                        if ($key == $fila[7]) {
